...
export default function Todo({ token, helmet }) {
                ...
                {todos.map((todo) => (
                  ...
                  >
                    {editingTodo.id === todo._id ? (
                      <>
                        ...
                        <td className="pb-2">
                          <button
                            ...
                            className=" ml-4 px-5 py-2 bg-gray-400 text-black rounded text-2xl"
                          >
                            Save
                          </button>
                        </td>
                        <td className="pl-4 pb-2">
                          <button
                            ...
                            className="px-4 py-2 bg-black text-white font-semibold rounded text-2xl"
                          >
                            Cancel
                          </button>
                        </td>
                      ...
                      <>
                        <td className="pb-2 pl-4 w-32 text-3xl">
                          {todo.title}
                        </td>
