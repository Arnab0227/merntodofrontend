...
export default function Login({handleLogin}) {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen">
          <div className='text-2xl font-semibold mb-10 '>Welcome Back, Login Here.</div>
          <form onSubmit={handleSubmit} className='w-1/3 border-2 rounded-2xl flex flex-col justify-center items-center p-5'>
            ...
            <button className='w-24 h-10 bg-black text-white rounded-lg mt-5' type="submit">Login</button>
          </form>
